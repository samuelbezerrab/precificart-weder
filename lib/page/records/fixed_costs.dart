...
class _FixedCostsScreenState extends State<FixedCostsScreen>
  ...
  Widget build(BuildContext context) {
    final Map<String, String> inputs = {"a": "a"};
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder(
          future: this.handler.retrieveFixedCost(),
          builder:
              (BuildContext context, AsyncSnapshot<List<FixedCost>> snapshot) {
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Dismissible(
                        ...
                        onDismissed: (DismissDirection direction) async {
                          await this
                              .handler
                              .deleteFixedCost(snapshot.data![index].id!);
                          setState(() {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        //         descriptions:
        //             "Adicione os seus custos fixos mensais para realizar o cálculo do preço de venda",
        //         // inputs: inputs,
        //         text: "Salvar",
        //       );
        //     }),
