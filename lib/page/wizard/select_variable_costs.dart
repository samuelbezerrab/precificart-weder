...
import 'package:precific_arte/page/wizard/insert_worked_hours.dart';
...
class SelectVariableCostsScreen extends StatefulWidget {
  @override
  _SelectVariableCostsScreenState createState() =>
      _SelectVariableCostsScreenState();
}

class _SelectVariableCostsScreenState extends State<SelectVariableCostsScreen>
        ...
        child: Column(
          children: [
            ...
            Expanded(
              flex: 1,
              child: Text(
                'Selecione os materiais utilizados na embalagem do produto.',
                style: TextStyle(
                  ...
                  switch (snapshot.connectionState) {
                    ...
                    case ConnectionState.done:
                      if (snapshot.hasError) {
                        ...
                        return Center(
                          child: Text(
                            'Você não tem materiais para utilizar na embalagem.',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => InsertWorkedHours(),
            ),
          );
        },
